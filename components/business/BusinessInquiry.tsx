...
export default function BusinessInquiry() {
  ...
  const title = o.title || 'Tell us about your business trip.';
  const subtitle = o.subtitle || 'Share your purpose, dates and the modules you are interested in. We will respond within 24 hours with a tailored proposal and pricing.';

  const features = (override?.inquiryFeatures as Array<{ icon: string; title: string; desc: string }> | undefined) || [
    { icon: 'ri-vip-crown-line', title: 'Truly personalized', desc: 'Built entirely around your goals and schedule.' },
    { icon: 'ri-team-line', title: 'Dedicated team', desc: 'A bilingual assistant and expert partners at every stage.' },
    { icon: 'ri-shield-check-line', title: 'Confidential & discreet', desc: 'Your business matters stay private and secure.' },
  ];
  ...
  return (
    <section id="inquiry" className="py-16 md:py-24 bg-white">
      <style>{`.company-field{position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;opacity:0;}`}</style>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-[#FBF7F2] rounded-3xl border border-neutral-200 p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700 mb-1.5">Modules of interest</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-700 mb-1.5">Duration of stay</label>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  maxLength={500}
                  placeholder="Describe your business purpose, meetings, and any specific needs..."
                  className={`${inputCls} resize-none`}
                />
                <div className="mt-1 text-right text-xs text-neutral-400">Max 500 characters</div>
              </div>

              <div className="company-field" aria-hidden="true">
                <label>Company</label>
                <input
                  name="company_alt"
                  type="text"
